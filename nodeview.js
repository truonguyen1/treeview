treeview = function() {
    ...
    var TEMPLATE = [
        '<div class="node-header">',
            '<div class="node-left node-header-left">',
                '<div class="node-collapse-icon"><button class="btn btn-link"><i class="fa fa-plus"></i></button></div>',
            '</div>',
            '<div class="node-middle node-header-middle">',
                '<span class="node-icon"></span><button class="node-text-btn btn btn-link"><div class="node-display-text"></div></button>',
            '</div>',
            '<div class="node-right node-header-right"></div>',
        '</div>',
        '<div class="node-body">',
            '<div class="node-left node-body-left"></div>',
            '<div class="node-middle node-body-middle">',
